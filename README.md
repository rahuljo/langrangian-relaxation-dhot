...
The rest of the code (building the MIP, computing objectives, updating multipliers and subgradients) are proprietary or modify existing proprietary code which belongs to Zuse Institut Berlin (ZIB). Some of those functions appear as stubs with a short description of what they do.
